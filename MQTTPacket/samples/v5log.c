...
static const char* v5property_identifier_to_string(int identifier)
{
    switch (identifier) 
    {
        ...
        case MQTTPROPERTY_CODE_ASSIGNED_CLIENT_IDENTIFIER:
                return "MQTTPROPERTY_CODE_ASSIGNED_CLIENT_IDENTIFIER";
...
const char* v5reasoncode_to_string(enum MQTTReasonCodes reasoncode)
{
    switch (reasoncode)
    {
        ...
        case MQTTREASONCODE_SHARED_SUBSCRIPTIONS_NOT_SUPPORTED:
            return "MQTTREASONCODE_SHARED_SUBSCRIPTIONS_NOT_SUPPORTED";
        ...
        case MQTTREASONCODE_WILDCARD_SUBSCRIPTIONS_NOT_SUPPORTED:
            return "MQTTREASONCODE_WILDCARD_SUBSCRIPTIONS_NOT_SUPPORTED";
        default:
